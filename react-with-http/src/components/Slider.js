        ...
        <section className={classes.slider_wrapper}>
            {
                imgList.map((v, i) => {
                    return(
                        <div key={i} className={`${classes.banner_slide}`} style={i === imgNum ? {flexBasis: "1000px", flexGrow: 1} : i === imgNum + 1 || i === imgNum + 2 ? {flexBasis: "100px"} : {flexBasis: "0px", margin: "0px", padding: "0px"}}>
